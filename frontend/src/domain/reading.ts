...
export const readingModes: { id: ReadingMode; title: string; description: string; icon: string }[] = [
  { id: 'phrases', title: 'Уровень 1 · Простые предложения', description: '5–7 слов: начинаем с простых предложений', icon: '🌱' },
  { id: 'sentences', title: 'Уровень 2 · Предложения', description: '8–12 слов: читаем более длинные предложения', icon: '🌷' },
  { id: 'advanced', title: 'Уровень 3 · Сложные предложения', description: '13–17 слов: читаем внимательно, делаем паузы', icon: '🌳' },
]
...
export const readingStars: Record<ReadingMode, number> = { phrases: 6, sentences: 9, advanced: 12 }
